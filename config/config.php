<?php return [
    ...
    'btns' => [
        'outlook' => [
            'label' => 'Mail Outlook',
            'class' => 'btn-secondary',
            'ajaxCaller' => 'onLoadOutlookBehaviorPopupForm',
            'ajaxInlineCaller' => 'onLoadOutlookBehaviorContentForm',
            'icon' => 'oc-wicon-microsoftoutlook',
        ],
        'lot_outlook' => [
            'label' => 'Lot Mails Outlook',
            'class' => 'btn-secondary',
            'ajaxInlineCaller' => 'onLotOutlook',
            'icon' => 'oc-wicon-microsoftoutlook',
        ],
    ],
];
